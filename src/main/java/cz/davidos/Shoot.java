...
public class Shoot {
    private long loadingTimer = System.currentTimeMillis();
    public boolean classicShoot(AssetManager assetManager, Node rootNode, BulletAppState bulletAppState, Vector3f dir, RigidBodyControl playerPhy){
        long now = System.currentTimeMillis();
        if (loadingTimer < now - 5000){
            loadingTimer = now;
